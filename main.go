...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=/cloudsql/spatil14-cbi:us-central1:mypostgres sslmode=disable port = 5432"
